    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 pb-10">
        ...
        <article className="px-5 max-w-2xl mx-auto pt-4 space-y-6">
          ...
          <div className="prose prose-sm md:prose-base max-w-none prose-headings:font-display prose-headings:font-bold prose-h2:text-xl prose-h2:mt-12 prose-h2:mb-5 prose-p:text-foreground/90 prose-p:leading-relaxed prose-p:my-8 prose-p:[&:not(:last-child)]:mb-10">
            {post.body}
          </div>
        </article>
      </div>
